...
<form>
  <div class="space-y-8 space-x-6 p-12">
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-blue-800">
              ...
              <input id="username" type="text" name="username" placeholder="" class="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" />
            </div>
          </div>
        </div>
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <p class="mt-1 text-sm/6 text-gray-600">Utilice una dirección permanente donde pueda recibir correo.</p>

      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          <label for="first-name" class="block text-sm/6 font-medium text-gray-900">Nombre</label>
          <input id="first-name" name="first-name" type="text" placeholder="Ingrese su nombre" autocomplete="given-name" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-3">
          <label for="last-name" class="block text-sm/6 font-medium text-gray-900">Apellido</label>
          <input id="last-name" name="last-name" type="text" placeholder="Ingrese su apellido" autocomplete="family-name" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-4">
          <label for="email" class="block text-sm/6 font-medium text-gray-900">Correo electrónico</label>
          <input id="email" name="email" placeholder="nombre@ejemplo.com" type="email" autocomplete="email" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-3">
          <label for="country" class="block text-sm/6 font-medium text-gray-900">País</label>
          <select id="country" name="country" autocomplete="country-name" class="mt-2 col-start-1 row-start-1 w-full rounded-md bg-white py-1.5 pr-8 pl-3 border outline-gray-300 focus:outline-blue-800">
        ...
        <div class="col-span-full">
          ...
          <input id="street-address" name="street-address" type="text" placeholder="Ingrese su dirección" autocomplete="street-address" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-2 sm:col-start-1">
          <label for="city" class="block text-sm/6 font-medium text-gray-900">Ciudad</label>
          <input id="city" name="city" type="text" placeholder="Ciudad" autocomplete="address-level2" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-2">
          <label for="region" class="block text-sm/6 font-medium text-gray-900">Provincia</label>
          <input id="region" name="region" type="text" placeholder="Provincia" autocomplete="address-level1" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>

        <div class="sm:col-span-2">
          <label for="postal-code" class="block text-sm/6 font-medium text-gray-900">Código Postal</label>
          <input id="postal-code" name="postal-code" type="text" placeholder="Código Postal" autocomplete="postal-code" class="mt-2 block w-full rounded-md bg-white px-3 py-1.5 outline-gray-300 focus:outline-blue-800"/>
        </div>
      </div>
    </div>
